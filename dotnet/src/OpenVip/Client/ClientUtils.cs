...
[assembly: InternalsVisibleTo("OpenVip.Test")]
...
namespace OpenVip.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is ControlRequest.OpenvipEnum controlRequestOpenvipEnum)
                return ControlRequest.OpenvipEnumToJsonValue(controlRequestOpenvipEnum);
            if (obj is ControlRequest.CommandEnum controlRequestCommandEnum)
                return ControlRequest.CommandEnumToJsonValue(controlRequestCommandEnum);
            if (obj is Error.OpenvipEnum errorOpenvipEnum)
                return Error.OpenvipEnumToJsonValue(errorOpenvipEnum);
            if (obj is Error.CodeEnum errorCodeEnum)
                return Error.CodeEnumToJsonValue(errorCodeEnum);
            if (obj is Message.OpenvipEnum messageOpenvipEnum)
                return Message.OpenvipEnumToJsonValue(messageOpenvipEnum);
            if (obj is Message.TypeEnum messageTypeEnum)
                return Message.TypeEnumToJsonValue(messageTypeEnum);
            if (obj is MessageXInput.OpsEnum messageXInputOpsEnum)
                return MessageXInput.OpsEnumToJsonValue(messageXInputOpsEnum);
            if (obj is Response.OpenvipEnum responseOpenvipEnum)
                return Response.OpenvipEnumToJsonValue(responseOpenvipEnum);
            if (obj is Response.StatusEnum responseStatusEnum)
                return Response.StatusEnumToJsonValue(responseStatusEnum);
            if (obj is SpeechRequest.OpenvipEnum speechRequestOpenvipEnum)
                return SpeechRequest.OpenvipEnumToJsonValue(speechRequestOpenvipEnum);
            if (obj is SpeechRequest.TypeEnum speechRequestTypeEnum)
                return SpeechRequest.TypeEnumToJsonValue(speechRequestTypeEnum);
            if (obj is SpeechResponse.OpenvipEnum speechResponseOpenvipEnum)
                return SpeechResponse.OpenvipEnumToJsonValue(speechResponseOpenvipEnum);
            if (obj is SpeechResponse.StatusEnum speechResponseStatusEnum)
                return SpeechResponse.StatusEnumToJsonValue(speechResponseStatusEnum);
            if (obj is Status.OpenvipEnum statusOpenvipEnum)
                return Status.OpenvipEnumToJsonValue(statusOpenvipEnum);
            if (obj is Transcription.OpenvipEnum transcriptionOpenvipEnum)
                return Transcription.OpenvipEnumToJsonValue(transcriptionOpenvipEnum);
            if (obj is Transcription.TypeEnum transcriptionTypeEnum)
                return Transcription.TypeEnumToJsonValue(transcriptionTypeEnum);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "http://localhost:8770/openvip";
        ...
        /// </summary>
        public const string CONTEXT_PATH = "/openvip";
