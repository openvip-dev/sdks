...
namespace OpenVip.Test.Api
{
    ...
    public sealed class MessagesApiTests : ApiTestsBase
    {
        ...
        public async Task SendMessageAsyncTest()
        {
            ...
            var response = await _instance.SendMessageAsync(agentId, transcription);
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task SubscribeAgentAsyncTest()
        {
            string agentId = default!;
            var response = await _instance.SubscribeAgentAsync(agentId);
            var model = response.Ok();
