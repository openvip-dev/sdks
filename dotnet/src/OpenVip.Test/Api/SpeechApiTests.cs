...
namespace OpenVip.Test.Api
{
    ...
    /// </summary>
    public sealed class SpeechApiTests : ApiTestsBase
    {
        private readonly ISpeechApi _instance;

        public SpeechApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ISpeechApi>();
        }
        ...
        public async Task StopSpeechAsyncTest()
        {
            var response = await _instance.StopSpeechAsync();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task TextToSpeechAsyncTest()
        {
            SpeechRequest speechRequest = default!;
            var response = await _instance.TextToSpeechAsync(speechRequest);
            var model = response.Ok();
            Assert.IsType<SpeechResponse>(model);
        }
    }
}
