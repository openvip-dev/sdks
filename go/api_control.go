...
func (r ApiSendControlRequest) Execute() (*Ack, *http.Response, error) {
...
//  @return Ack
func (a *ControlAPIService) SendControlExecute(r ApiSendControlRequest) (*Ack, *http.Response, error) {
	var (
