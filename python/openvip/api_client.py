...
from openvip.configuration import Configuration
from openvip.api_response import ApiResponse, T as ApiResponseT
import openvip.models
from openvip import rest
from openvip.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(openvip.models, klass)
