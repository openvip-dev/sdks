...
class ControlApi:
    ...
    def send_control(
        ...
        :param control_request: (required)
        :type control_request: ControlRequest
        ...
        _param = self._send_control_serialize(
    ...
    @validate_call
    def send_control_with_http_info(
        self,
        control_request: ControlRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def send_control_without_preload_content(
        self,
        control_request: ControlRequest,
        _request_timeout: Union[
            None,
