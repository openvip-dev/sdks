...
class SpeechApi:
    ...
    def stop_speech(
        ...
        _param = self._stop_speech_serialize(
    ...
    @validate_call
    def stop_speech_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def stop_speech_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
