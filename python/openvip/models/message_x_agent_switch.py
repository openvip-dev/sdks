...
class MessageXAgentSwitch(BaseModel):
    """
    Standard extension: agent routing
    """ # noqa: E501
    target: StrictStr = Field(description="Identifier of the agent to switch to")
    confidence: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=None, description="Confidence score (0.0–1.0)")
    ...
    __properties: ClassVar[List[str]] = ["target", "confidence", "source"]
