...
class Error(BaseModel):
    ...
    id: Optional[UUID] = Field(default=None, description="Unique identifier for this error (assigned by the engine)")
    ref: Optional[UUID] = Field(default=None, description="ID of the request that caused this error")
    __properties: ClassVar[List[str]] = ["openvip", "error", "code", "id", "ref"]
