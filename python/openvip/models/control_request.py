...
class ControlRequest(BaseModel):
    ...
    id: UUID = Field(description="Unique request identifier (UUID v4)")
    command: StrictStr = Field(description="Command to execute")
    __properties: ClassVar[List[str]] = ["openvip", "id", "command"]
