...
class StatusStt(BaseModel):
    """
    Speech-to-text service status
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="STT service available on this engine")
    active: Optional[StrictBool] = Field(default=None, description="Microphone is currently listening")
    __properties: ClassVar[List[str]] = ["enabled", "active"]
